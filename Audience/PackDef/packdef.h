...
#define UM_QUITNTF WM_USER + 10
#define UM_GIFTMSG WM_USER + 11
#define UM_FAVORITERSSG WM_USER + 12
#define UM_ALLFAVORITESG WM_USER + 13
#define UM_KAIBONTFMSG WM_USER + 14
